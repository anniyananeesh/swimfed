...
class thumbnail_images {
	...
	function imagejpeg_new ($NewImg,$path_img) {
		if ($this->mime == 'image/jpeg' or $this->mime == 'image/pjpeg') imagejpeg($NewImg,$path_img,90);
			elseif ($this->mime == 'image/gif') imagegif($NewImg,$path_img);
			elseif ($this->mime == 'image/png'){

				$remove = imagecolorallocate($NewImg, 0, 0, 0);
			    imagecolortransparent($NewImg, $remove);
