...
<script type="text/javascript">
    ...
    myApp.controller('SignupCtrl',function($scope, $http, $window) {
          ...
          $scope.user = {
              ...
              discipline: '',
              note: '',
              type: '<?php echo ucfirst($activeTab)?>'
          };

          var settings = {
              url: "<?php echo HOST_URL?>/Async/<?php echo CLUB_URL?>/upload_member_image",
              dragDrop:false,
              fileName: "myfile",
              returnType:"json",
              showDelete:true,
              ...
              customProgressBar: function(obj,s) {
                ...
                onSuccess:function(files,data,xhr,pd) {
                    ...
                    var request = $http({
                        method: "post",
                        url: "<?php echo HOST_URL?>/Async/<?php echo CLUB_URL?>/set_profile_image",
                        data: setParams,
                        headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
                    });

                    request.success(function (data) {
                        uploadOtherDetails.startUpload();
                    });
          ...
          var settingsOtherDetails = {
              url: "<?php echo HOST_URL?>/Async/<?php echo CLUB_URL?>/upload_other_details",
              dragDrop:false,
              ...
              customProgressBar: function(obj,s) {
                ...
                onSuccess:function(files,data,xhr,pd) {
                    ...
                    var request = $http({
                        method: "post",
                        url: "<?php echo HOST_URL?>/Async/<?php echo CLUB_URL?>/set_visa_image",
                        data: setParams,
                        headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
                    });

                    request.success(function (data) {
                        uploadSponsor.startUpload();
                    });
          ...
          var settingsSponsor = {
              url: "<?php echo HOST_URL?>/Async/<?php echo CLUB_URL?>/upload_sponsor",
              dragDrop:false,
              ...
              customProgressBar: function(obj,s) {
                ...
                onSuccess:function(files,data,xhr,pd) {
                    ...
                    var request = $http({
                        method: "post",
                        url: "<?php echo HOST_URL?>/Async/<?php echo CLUB_URL?>/set_sponsor_details",
                        data: setParams,
                        headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
                    });

                    request.success(function (data) {
                        uploadClubCertificate.startUpload();
                    });
                }
          ...
          var settingsClubCertificate = {
              ...
              customProgressBar: function(obj,s) {
                ...
                onSuccess:function(files,data,xhr,pd) {
                    ...
                    var request = $http({
                        method: "post",
                        url: "<?php echo HOST_URL?>/Async/<?php echo CLUB_URL?>/set_club_certificate",
                        data: setParams,
                        headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
                    });
          ...
          $scope.submitForm = function(valid) {
               ...
               if(valid) {
                   ...
                   var request = $http({
                        method: "post",
                        url: "<?php echo HOST_URL?>/Async/<?php echo CLUB_URL?>/add_member",
                        data: $scope.user,
                        headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
                   });
                   ...
                   request.success(function (data) {
                        ...
                        if(!data.error) {
                            ...
                            $("#memberID").val(data.data.key);

                            //Upload passport photo
                            uploadPhoto.startUpload();
        ...
        <div class="forms">
            <div class="row">
                ...
                <div class="form-three widget-shadow">
                    ...
                    <!--******TAB CONTEND************-->
                    <div class="tabcontent" ng-app="myApp">

                        <!--******FORM PLAYER START************-->
                        <div class="tab-pane" id="home" ng-controller="SignupCtrl">

                            <form class="form-horizontal" id="member_add_frm" name="member_add_frm" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control1" id="first_name" name="first_name" placeholder="" ng-model="user.first_name" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control1" id="last_name" name="last_name" placeholder="" ng-model="user.last_name" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control1" id="father_name" name="father_name" placeholder="" ng-model="user.father_name" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <label class="radio-inline">
                                                <input type="radio" name="gender" value="male" ng-checked="user.gender == 'male'" ng-click="user.gender = 'male'"> Male
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="gender" value="female" ng-checked="user.gender == 'female'" ng-click="user.gender = 'female'"> Female
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control1" id="dob" name="dob" placeholder="MM/DD/YY" ng-model="user.dob" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control1" id="passport_no" name="passport_no" placeholder="" ng-model="user.passport_no" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control1" name="passport_expiry" id="passport_expiry" placeholder="DD/MM/YY" ng-model="user.passport_expiry" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="country" id="country" class="form-control1" required ng-model="user.country">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="emirate" id="emirate" class="form-control1" required ng-model="user.emirate">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control1" id="city" name="city" required placeholder="" ng-model="user.city">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control1" id="contact_no" required name="contact_no" placeholder="05" ng-model="user.contact_no" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <select name="discipline" id="discipline" class="form-control1" required ng-model="user.discipline">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="note" id="note" cols="50" rows="8" required class="form-control3" ng-model="user.note"><?php echo ($post['note'] != NULL && $post['note'] != '') ? $post['note'] : '';?></textarea>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="compose-right">
                                        ...
                                        <div class="form-group mb-n">
                                            ...
                                            <div id="passportPhotoUploadBtn" class="btn btn-default btn-file blue_button2" style="padding: 0px;"><i class="fa fa-paperclip"></i> Upload Passport size photo!</div>
                                    ...
                                    <div class="compose-right">
                                        ...
                                        <div class="form-group mb-n">
                                            ...
                                            <div id="passportDetailsUploadBtn" class="btn btn-default btn-file blue_button2" style="padding: 0px;"><i class="fa fa-paperclip"></i> Upload Passport size photo!</div>
                                            <div class="clearfix"></div>
                                    ...
                                    <div class="compose-right">
                                        ...
                                        <div class="form-group mb-n">
                                            ...
                                            <div id="sponsorUploadBtn" class="btn btn-default btn-file blue_button2" style="padding: 0px;"><i class="fa fa-paperclip"></i> Upload Passport size photo!</div>
                                            <div class="clearfix"></div>
                                            <p class="help-block">Upload Passport & Emirates ID | Max. 3Mb</p>
                                    ...
                                    <div class="compose-right">
                                        ...
                                        <div class="form-group mb-n">
                                            ...
                                            <div id="clubCertificateUploadBtn" class="btn btn-default btn-file blue_button2" style="padding: 0px;"><i class="fa fa-paperclip"></i> Upload Passport size photo!</div>
                                            <div class="clearfix"></div>
                                ...
                                <div class="form-group mb-n">
                                    ...
                                    <div class="col-sm-6 ">
                                        <input class="green_button" ng-click="submitForm(member_add_frm.$valid)" type="button" id="submit_data" name="Sign In" value="Save Member Details">
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                            </form>
