...
<script language="javascript">
	...
	function DeleteUserFile(filename, fieldname, memberID) {
  		document.frmDelete.file_name.value = filename;
  		document.frmDelete.field_name.value = fieldname;
  		document.frmDelete.delete_file.value = "Y";
      document.frmDelete.member.value = memberID;
  		document.frmDelete.submit();
	}

  function DeleteUserProfilePicFile(filename, fieldname, memberID) {
  		document.frmProfilePicDelete.file_name.value = filename;
  		document.frmProfilePicDelete.field_name.value = fieldname;
  		document.frmProfilePicDelete.delete_file.value = "Y";
      document.frmProfilePicDelete.member.value = memberID;
  		document.frmProfilePicDelete.submit();
	}


  function DeleteVisaFile(filename, fieldname, memberID) {
  		document.frmVisaFileDelete.file_name.value = filename;
  		document.frmVisaFileDelete.field_name.value = fieldname;
  		document.frmVisaFileDelete.delete_file.value = "Y";
      document.frmVisaFileDelete.member.value = memberID;
  		document.frmVisaFileDelete.submit();
	}

  function DeleteSponsorFile(filename, fieldname, memberID) {
  		document.frmSponsorFileDelete.file_name.value = filename;
  		document.frmSponsorFileDelete.field_name.value = fieldname;
  		document.frmSponsorFileDelete.delete_file.value = "Y";
      document.frmSponsorFileDelete.member.value = memberID;
  		document.frmSponsorFileDelete.submit();
	}
