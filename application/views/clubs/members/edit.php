        ...
        <div class="forms">
            <div class="row">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <label class="radio-inline">
                                      <input type="radio" name="gender" value="male" <?php echo (isset($post['gender']) && $post['gender'] == 'male') ? 'checked' : '';?>> Male
                                  </label>
                                  <label class="radio-inline">
                                      <input type="radio" name="gender" value="female" <?php echo (isset($post['gender']) && $post['gender'] == 'female') ? 'checked' : '';?>> Female
                                  </label>
                ...
                <div class="tool-tips widget-shadow">
                    <h4 class="title2">Remove Member Info :</h4>
                    <div class="bs-example-tooltips">
                        <a href='<?php echo $ctrlUrl?>/delete/<?php echo $this->mencrypt->encode($record->id)?>' id="remove-club-member" data-id="<?php echo $this->mencrypt->encode($record->id)?>" class="btn red_button2" data-toggle="tooltip" data-placement="right" title="" data-original-title="Once you Click you will remove all the informations about this member from the database">REMOVE INFO</a>
                        <script>
                            $(function() {
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $(document).on('click', '#remove-club-member', function(res){

            if(confirm("Do you want to delete this member from club?")) {
