...
<script type="text/javascript">/*<![CDATA[*/$(function(){$(document).on("click","#reset-password-btn",function(c){var b=$(document).find("#password").val(),a=$(document).find("#cpassword").val();if((b!=a)&&(b!=""&&a!="")){alert("Both the passwords must be equal and not empty");c.preventDefault();return false}else{return true}})});/*]]>*/</script>
<div id="page-wrapper">
<div class="main-page">
<div class="forms">
<div class="row">
...
<script type="text/javascript">/*<![CDATA[*/$(function(){$(document).on("click","#send-password-club",function(){var a=$(this).attr("data-id");if(confirm("Do you want to send the new password to club")){$.post("<?php echo HOST_URL . "/Async/" . ADMIN_URL ?>/send_password_club/",{user:a},function(b){if(b.code==200){alert("New password has been send")}else{alert(" Response error . please refresh the page")}},"json")}})});/*]]>*/</script>
