...
<script type="text/javascript">/*<![CDATA[*/$(function(){$(document).on("click","#generate_club_code",function(){var a=$("#club_code");$.get("<?php echo HOST_URL?>/Async/<?php echo ADMIN_URL?>/getUniqueCodeClub",function(b){if(b.code==200){a.val(b.data)}else{alert("Error reading data from server")}},"json");return false})});/*]]>*/</script>
